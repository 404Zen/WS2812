...
#define  OS_CFG_STAT_TASK_PRIO			(OS_CFG_PRIO_MAX - 2u) /* 修改为倒数第二优先级                                          */
...
/* ------------------------ TICKS 时钟节拍----------------------- */
#define  OS_CFG_TICK_RATE_HZ             1000u              /* Tick rate in Hertz (10 to 1000 Hz) 时钟节拍 每秒Tick数                    */
#define  OS_CFG_TICK_TASK_PRIO             1u               /* Priority                           优先级                      */
...
/* ----------------------- TIMERS 定时器----------------------- */
#define  OS_CFG_TMR_TASK_PRIO              2u               /* Priority of 'Timer Task'            定时器的优先级                   */
#define  OS_CFG_TMR_TASK_RATE_HZ         1000u              /* Rate for timers (10 Hz Typ.)        定时器的每秒节拍数                        */
